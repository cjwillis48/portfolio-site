...
<nav
	class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-200 dark:bg-slate-950/95 dark:border-slate-800"
>
	<div class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
		<a
			href="/"
			class="font-bold text-slate-900 text-lg tracking-tight hover:text-indigo-600 transition-colors dark:text-slate-100 dark:hover:text-indigo-400"
		>
			Charlie Willis
		</a>
	...
	{#if menuOpen}
		<div
			class="md:hidden border-t border-slate-200 bg-white px-4 py-2 dark:border-slate-800 dark:bg-slate-950"
		>
